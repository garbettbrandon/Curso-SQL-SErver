/*HAVING debe ser insertado entre las cl�usulas GROUP BY y ORDER BY. Adem�s, HAVING es
...
n_companies igual al n�mero 202.*/
...
/* Proporciona una segunda soluci�n al ejercicio utilizando
solo cl�usulas WHERE (recuerda utilizar WITH).*/
...
verifiquen la condici�n sum_revenue > 100000000.*/
...
/* Proporciona una segunda soluci�n al
ejercicio utilizando solo cl�usulas WHERE (recuerda utilizar WITH).*/
