...
/*2. Comprueba si la columna Weight puede contener NULLs. En caso afirmativo, haz un
 ...
 tambi�n el porcentaje que representa respecto al total de filas de la tabla en �pct_records�*/
SELECT
...
/* 4. Inserta una columna �new_minimum� que tome el valor Weight siempre que su valor sea
 ...
 el valor esperado para los 10 valores m�s peque�os de Weight devolviendo ambas
 columnas. Evita duplicados: */
SELECT
  DISTINCT TOP 10 weight,
  CASE
    WHEN weight > 10 THEN weight
    else 10
  END AS new_minimun
FROM
  production.product
...
/* 5. De forma similar, ahora calcula una columna �new_min_max� que tome el valor Weight
 siempre que su valor est� comprendido entre 10 y 900. En caso contrario, que tome el valor
 m�s cercano a los extremos {10, 900}. Comprueba tu soluci�n: */
SELECT
  DISTINCT Weight,
  CASE
    WHEN Weight <= 10
    OR Weight IS NULL THEN 10.00
...
/* Crea una columna tag_format que tome el valor 1 cuando el string de ProductNumber
 contenga un gui�n y 0 en caso contrario. Filtra instancias que s�lo tengan valores de Class
 �L� o �M� y haz un conteo de filas. Comprueba tu soluci�n: */
SELECT
  CASE
